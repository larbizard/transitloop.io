            ...
            <div className="pt-20">
                <div className="flex flex-row justify-center">
                    <div className="p-8 lg:px-20">
                        <h1 id="titre-principal" className="text-2xl font-bold text-left mb-6">
                            TERMS AND CONDITIONS OF USE
                        </h1>
                        <h2 id="sous-titre" className="text-xl font-bold py-4 text-left">
                            for the Blassty Application
                        </h2>

                        <h3 id="definitions" className="text-xl font-bold py-4">Definitions</h3>
                        <p className="py-2">
                            <strong>"Blassty Application" and/or "Application"</strong>: the mobile application allowing the Client to access route planning and calculation services for transport modes operated and/or managed by Rabat Region Mobility (RRM), namely: Rabat-Salé Tramway, Rabat Buses, Motorcycles, and RRM-managed Parking.
                        </p>
                        <p className="py-2">
                        ...
                        <h3 id="article-1" className="text-xl font-bold py-4">Article 1: Purpose</h3>
                        <p className="py-2">
                        ...
                        <p className="py-2">
                            These Terms and Conditions may be modified by Rabat Region Mobility in case of regulatory, technical, or commercial evolution. The Client will be informed by any appropriate means. The absence of objection within 30 days following the information constitutes acceptance.
                        </p>

                        <h3 id="article-3" className="text-xl font-bold py-4">Article 3: Duration and Entry into Force</h3>
                        <p className="py-2">
                            The Contract takes effect from the opening of the Client Account and acceptance of these Terms and Conditions, and remains valid until its closure by the Client or Rabat Region Mobility.
                        </p>

                        <h3 id="article-4" className="text-xl font-bold py-4">Article 4: Account Opening and Activation</h3>
                        <ul className="list-disc ml-4 p-4">
                            ...
                            <li>Rabat Region Mobility may suspend an Account in case of fraud, false declaration, or upon request from authorities.</li>
                        </ul>

                        <h3 id="article-5" className="text-xl font-bold py-4">Article 5: Account Operation and Services</h3>
                        ...
                        <h3 id="article-6" className="text-xl font-bold py-4">Article 6: Security and Confidentiality</h3>
                        <ul className="list-disc ml-4 p-4">
                        ...
                        <h3 id="article-7" className="text-xl font-bold py-4">Article 7: Account Closure</h3>
                        ...
                        <ul className="list-disc ml-4 p-4">
                            ...
                            <li><strong>By Rabat Region Mobility</strong>: in case of death, fraud, false declaration, request from an authority, 12 months of inactivity, or violation of these Terms and Conditions.</li>
                        </ul>

                        <h3 id="article-8" className="text-xl font-bold py-4">Article 8: Fare Information</h3>
                        <ul className="list-disc ml-4 p-4">
                        ...
                        <h3 id="article-9" className="text-xl font-bold py-4">Article 9: Personal Data Protection</h3>
                        <p className="py-2">
                        ...
                        <h4 id="article-9-1" className="text-lg font-semibold py-2">9.1. Data Controller</h4>
                        <p className="py-2">
                            ...
                            <br />
                            <strong>TransitLoop</strong> - Subcontractor<br />
                            Registered office: 310, rue Omar Riffi, 20250 Casablanca, Morocco<br />
                            Trade register: Casablanca n° 671237
                        </p>

                        <h4 id="article-9-2" className="text-lg font-semibold py-2">9.2. Processing Purposes</h4>
                        <ul className="list-disc ml-4 p-4">
                        ...
                        <h4 id="article-9-3" className="text-lg font-semibold py-2">9.3. Data Collected</h4>
                        <ul className="list-disc ml-4 p-4">
                        ...
                        <h4 id="article-9-4" className="text-lg font-semibold py-2">9.4. Legal Basis for Processing</h4>
                        <p className="py-2">
                            Processing is based on Rabat Region Mobility (RRM)'s legitimate interest in providing route planning services and on user consent for optional data.
                        </p>

                        <h4 id="article-9-5" className="text-lg font-semibold py-2">9.5. Data Recipients</h4>
                        <ul className="list-disc ml-4 p-4">
                            <li>Rabat Region Mobility (RRM) - (data controller)</li>
                            <li>TransitLoop (subcontractor)</li>
                        ...
                        <h4 id="article-9-6" className="text-lg font-semibold py-2">9.6. Retention Period</h4>
                        <p className="py-2">
                        ...
                        <h4 id="article-9-7" className="text-lg font-semibold py-2">9.7. User Rights</h4>
                        <p className="py-2">
                        ...
                        <h4 id="article-9-8" className="text-lg font-semibold py-2">9.8. Exercising Rights</h4>
                        <p className="py-2">
                            To exercise your rights, contact us:<br />
                            <strong>Email:</strong> contact@blassty.ma<br />
                        ...
                        <p className="py-2">
                            This processing has been subject to a declaration / authorization request to the CNDP under number ………… The collected personal data may be transmitted to Rabat Region Mobility and to TransitLoop in accordance with the transfer request filed with the CNDP.
                        </p>
                        ...
                        <h3 id="article-10" className="text-xl font-bold py-4">Article 10: Client Commitments</h3>
                        ...
                        <h3 id="article-11" className="text-xl font-bold py-4">Article 11: Rabat Region Mobility Responsibilities</h3>
                        <p className="py-2">Rabat Region Mobility undertakes to:</p>
                        <ul className="list-disc ml-4 p-4">
                        ...
                        <p className="py-2">Rabat Region Mobility is not responsible for:</p>
                        <ul className="list-disc ml-4 p-4">
                        ...
                        <h3 id="article-12" className="text-xl font-bold py-4">Article 12: Complaints</h3>
                        ...
                        <h3 id="article-13" className="text-xl font-bold py-4">Article 13: Applicable Law and Disputes</h3>
                        <ul className="list-disc ml-4 p-4">
