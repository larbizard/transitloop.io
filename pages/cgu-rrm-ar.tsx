            ...
            <div className="pt-20">
                <div className="flex flex-row justify-center">
                    <div className="p-8 lg:px-20">
                        ...
                        <p className="py-2">
                            يمكن تعديل هذه الشروط من قبل الرباط الجهة للتنقل في حالة التطور التنظيمي أو التقني أو التجاري. سيتم إعلام العميل بأي وسيلة مناسبة. عدم الاعتراض خلال 30 يوماً من الإعلام يعتبر قبولاً.
                        </p>

                        <h3 id="article-3" className="text-xl font-bold py-4">المادة 3: المدة وسريان النفاذ</h3>
                        <p className="py-2">
                            يدخل العقد حيز التنفيذ من تاريخ فتح حساب العميل وقبول هذه الشروط، ويبقى ساري المفعول حتى إغلاقه من قبل العميل أو الرباط الجهة للتنقل.
                        </p>
                        ...
                        <ul className="list-disc ml-4 p-4">
                            ...
                            <li>يمكن للرباط الجهة للتنقل تعليق الحساب في حالة الاحتيال أو الإدلاء بمعلومات كاذبة أو بناءً على طلب السلطات.</li>
                        </ul>
                        ...
                        <ul className="list-disc ml-4 p-4">
                            ...
                            <li><strong>من قبل الرباط الجهة للتنقل</strong> : في حالة الوفاة، الاحتيال، الإدلاء بمعلومات كاذبة، طلب من سلطة، عدم نشاط لمدة 12 شهراً، أو انتهاك هذه الشروط.</li>
                        </ul>
                        ...
                        <p className="py-2">
                            هذا المعالجة موضوع إعلان / طلب ترخيص لدى الهيئة الوطنية لحماية المعطيات الشخصية تحت الرقم D-W-1956/2025. في هذا الإطار، يتم ضمان حماية البيانات ذات الطابع الشخصي وفقاً للقانون 09-08 ومتطلبات الهيئة الوطنية لحماية المعطيات الشخصية. يمكن نقل البيانات الشخصية المجمعة إلى الرباط الجهة للتنقل وإلى ترانزيت لوب وفقاً لطلب النقل المودع لدى الهيئة الوطنية لحماية المعطيات الشخصية.
                        </p>
                        ...
                        <h3 id="article-11" className="text-xl font-bold py-4">المادة 11: مسؤوليات الرباط الجهة للتنقل</h3>
                        <p className="py-2">تتعهد الرباط الجهة للتنقل بـ:</p>
                        <ul className="list-disc ml-4 p-4">
                        ...
                        <p className="py-2">الرباط الجهة للتنقل غير مسؤولة عن:</p>
                        <ul className="list-disc ml-4 p-4">
